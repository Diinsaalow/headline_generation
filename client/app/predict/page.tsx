...
export default function PredictPage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (!trimmedArticle || !selectedModel) return;
    ...
    try {
      ...
      setResult({
        headline: data.headline || "No headline generated.",
      ...
      <div className="mx-auto max-w-3xl px-6 py-16">
        <div className="mb-10 text-center">
          ...
          <p className="text-slate-600">
            Choose a model, paste your Somali news article, and review the
            generated headline and category.
          </p>
        </div>
          ...
          <div className="relative max-h-[calc(100dvh-2rem)] w-full max-w-xl overflow-y-auto rounded-xl border border-slate-200 bg-white shadow-2xl">
            ...
            <div className="border-t border-slate-200 bg-slate-50 px-6 py-4">
              <button
                type="button"
                onClick={() => setModalOpen(false)}
                className="w-full rounded-md border border-blue-600 bg-blue-600 px-4 py-3 text-sm font-medium text-white transition-colors hover:border-blue-700 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2"
              >
                Done
              </button>
            </div>
